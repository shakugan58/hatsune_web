...
let data_judge2 = [];
let avoid_choking = 0;
let nPaint_layout = 'force';//or 'circular'
//----------------------------------------------------
...
function after_url(nodes,links,degree_dis,para){
    ...
    document.getElementById("Edge_num-count").innerHTML = para[3];
